...
#### การติดตั้งบน iPad/iPhone:
1. เปิด Safari แล้วเข้าเว็บไซต์ระบบ
2. กดปุ่ม **Share** (ไอคอนสี่เหลี่ยมมีลูกศรชี้ขึ้น)
3. เลื่อนลงแล้วกด **"Add to Home Screen"**
4. ตั้งชื่อแล้วกด **"Add"**
5. เปิดแอปจาก Home Screen ได้เลย!

#### Features:
- ✅ **Standalone Mode**: เปิดเต็มจอไม่มี Browser Bar
